        ...
        {[1, 2, 3].map((item) => {
          return (
            <AccordionItem
              key={item}
              value={"item" + item}
              className="mb-6 bg-white rounded-3xl"
            >
              <AccordionTrigger className="border-b p-6 data-[state=closed]:border-b-0">
                <p className="text-text-500-80 text-16 font-bold">
                  September 2024 (2)
                </p>
              </AccordionTrigger>
              <AccordionContent>
                ...
                >
                  {people.map((item) => (
                    <li
                      key={item.asset}
                      className="flex flex-col lg:flex-row gap-4 justify-between gap-x-6 p-6 last:pb-0"
                    >
